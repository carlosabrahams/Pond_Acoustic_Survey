...
In practical terms (and depending on the model of recording device used), it may be easier in the field to record a single sound file for the pond sample, and separate each one-minute sub-sample with a voice notification or electronic 'slate' so that the file can be separated into one-minute files during later analysis.
...
Environmental information about the pond habitat should be recorded using the field survey form (PDF available for download [here](PAS_field_data_form.pdf)).  This has been designed for compatibility with information collected for two existing survey methods: [Great Crested Newt Habitat Suitability Index - ARG Advice Note 5](https://www.arguk.org/component/docman/?task=doc_download&gid=9&Itemid=10), and Freshwater Habitats Trust [PSYM](https://freshwaterhabitats.org.uk/wp-content/uploads/2019/12/PSYM-MANUAL-AUG-2019.pdf). Further information on field assessment of the recorded environmental variables can be found in the linked documents.
